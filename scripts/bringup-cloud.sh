...
info "Paste both into the app: menu-bar icon -> Settings... -> Cloud sync."
info "Press Test connection before Save — it tells a wrong URL apart from a"
info "wrong token, which is otherwise invisible. docs/BRINGUP.md step 21."
